...
//     try {
//         // Validate input IDs
//         if (!mongoose.Types.ObjectId.isValid(clientId) || !mongoose.Types.ObjectId.isValid(vendorId)) {
//             return res.status(400).json({ error: 'Invalid clientId or vendorId' });
//         }
...
//         // Send the conversation details as the response
//         res.status(200).json(conversation);
//     } catch (error) {
